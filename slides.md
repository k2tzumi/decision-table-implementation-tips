...
<!--
結構複雑です  
先程のスライドでは1画面に収まるものをピックアップしたのですが、もっと巨大で複雑なものがあります
-->
...
<!--
さらに複雑なのは、これらの表形式の資料の元となる原文で報酬告示と呼ばれるものです。  
官報という形式で縦書き且つ、法律の文体で書かれており、非常に理解しづらくなっています。
-->
...
[click] 判断基準は明確でルール化しやすいものの、頻繁な制度変更や例外対応により、運用が複雑化しやすい点が特徴です
-->
...
これにより、見通しがよくメンテナンスしやすくなり、大半のルールが未評価のままで済み、ジェネレーターとの相性も良いです。
-->
